// Auto-generated from Cleenzo catalog (backend source of truth).
// Run: cd cleenzo-backend && npm run prisma:export-website-pricing
export const GHAZIABAD_PRICING = {
  "promoStrip": "Free pickup & delivery on orders above ₹480",
  "city": "Ghaziabad",
  "serviceTabs": [
    {
      "id": "dry-clean",
  ...
  "items": {
    "dry-clean": {
      ...
      "luxury": [
        ...
        {
          "name": "Jacket - Short ( including leather ) (Men)",
          "price": 899
        },
        {
          "name": "Jacket - Short ( including leather ) (Women)",
          "price": 499
        },
        {
    ...
    "steam-iron": {
      ...
      "women": [
        ...
        {
          "name": "Kurta + paints / salwar / churidar",
          "price": 99
        },
        {
          "name": "Kurta + paints / salwar / churidar + dupatta",
          "price": 149
        },
        {
          "name": "Ladies Suit 2pcs",
  ...
  "addons": {
    "dry-clean": [
      {
        "name": "Alteration Fitting Pant",
        "price": 250
      },
      {
        "name": "Alteration Length",
        "price": 150
      },
      {
        "name": "Button Stiching",
        "price": 50
      },
      {
        "name": "Darning Large",
