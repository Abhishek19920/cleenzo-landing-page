/** Apple logo — used on official-style App Store download buttons */
export function AppleIcon({ className = "w-8 h-8" }) {
  return (
...
/** App Store — same Apple mark as on iPhone / official App Store badges */
export function AppStoreIcon(props) {
  return <AppleIcon {...props} />;
}

export function GooglePlayIcon({ className = "w-8 h-8" }) {
  return (
