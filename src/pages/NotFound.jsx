...
function NotFound() {
  return (
    <section className="min-h-[70vh] flex items-center justify-center bg-slate-950 text-white px-6 py-20">
      <div className="max-w-lg text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="bg-cyan-400 text-black font-bold px-8 py-4 rounded-2xl hover:scale-105 transition"
          >
            Go to homepage
          </Link>
          <a
